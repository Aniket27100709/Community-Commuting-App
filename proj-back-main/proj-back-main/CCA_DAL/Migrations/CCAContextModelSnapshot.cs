...
{
    [DbContext(typeof(CCAContext))]
    partial class CCAContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCA_DAL.Models.RideInfo", b =>
                {
            ...
            modelBuilder.Entity("CCA_DAL.Models.RideProvide", b =>
                {
                    b.Property<string>("rpId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateOnly>("validUpto")
                        .HasColumnType("date")
                        .HasAnnotation("MinValue", new DateTime(2024, 4, 25, 12, 24, 50, 705, DateTimeKind.Local).AddTicks(3894));
            ...
            modelBuilder.Entity("CCA_DAL.Models.Smile", b =>
                {
            ...
            modelBuilder.Entity("CCA_DAL.Models.RideInfo", b =>
                {
                    b.HasOne("CCA_DAL.Models.RideProvide", "rideProvide")
                        .WithMany("RideInfos")
                        .HasForeignKey("rpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CCA_DAL.Models.Smile", b =>
                {
                    b.HasOne("CCA_DAL.Models.RideInfo", "rideInfo")
                        .WithMany("Smiles")
                        .HasForeignKey("rpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
